...
class _SignInScreenState extends ConsumerState<SignInScreen> {
  ...
  void _trySubmit() async {
    ...
    if (isValid == true) {
      ...
      print("DEBUG: SignInScreen - Attempting to sign in with Email: $_email"); // DEBUG
  ...
  Widget build(BuildContext context) {
    ...
    final authScreenState = ref.watch(authNotifierProvider); // For isLoading and error
    final authNotifier = ref.read(authNotifierProvider.notifier);

    ref.listen<AuthScreenState>(authNotifierProvider, (previous, next) {
      print("DEBUG: SignInScreen listener - Prev User: ${previous?.user?.uid}, Next User: ${next.user?.uid}, Error: ${next.error}, Loading: ${next.isLoading}"); // DEBUG
      ...
      if (next.user != null) {
        print("DEBUG: SignInScreen listener - User is now available: ${next.user!.uid}. GoRouter should redirect.");
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextButton(
                  ...
                  onPressed: () {
                    print("DEBUG: SignInScreen - Navigating to signup"); // DEBUG
