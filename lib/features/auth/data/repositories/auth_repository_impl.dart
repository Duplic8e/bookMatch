...
import 'package:bookmatch/features/auth/domain/repositories/auth_repository.dart';
import 'package:bookmatch/features/user_profile/domain/repositories/user_profile_repository.dart'; // Make sure this import is correct

class AuthRepositoryImpl implements AuthRepository {
  final FirebaseAuthDataSource _firebaseAuthDataSource;
  final UserProfileRepository
  _userProfileRepository; // Assuming you still have this
  ...
  Future<firebase_auth.User?> signUpWithEmailAndPassword({
    ...
    final firebaseUser = await _firebaseAuthDataSource
    ...
    if (firebaseUser != null) {
      try {
        ...
        print(
          "Error creating user profile in Firestore: $e. User ${firebaseUser.uid} is signed up in Auth.",
        );
