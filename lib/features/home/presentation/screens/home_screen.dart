...
import 'package:mobile_app_project_bookstore/features/auth/presentation/providers/auth_providers.dart'; // Assuming this path
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final booksAsyncValue = ref.watch(allBooksProvider); // Uses allBooksProvider
              ...
              data: (books) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final book = books[index]; // book is of type Book from domain/entities
                    return Card(
                      ...
                      child: ListTile(
                        leading: Hero(
                          ...
                          child: book.coverImageUrl.isNotEmpty
                              ? Image.network(book.coverImageUrl, fit: BoxFit.cover, width: 50, height: 70, errorBuilder: (context, error, stackTrace) => const Icon(Icons.broken_image, size: 50))
