...
import 'package:mobile_app_project_bookstore/features/auth/presentation/screens/reset_password_screen.dart';
import 'package:mobile_app_project_bookstore/features/auth/presentation/screens/notification_controls_screen.dart'; // ✅ added
...
import 'package:mobile_app_project_bookstore/features/cart/presentation/screens/cart_screen.dart' as cart;
import 'package:mobile_app_project_bookstore/features/cart/presentation/screens/checkout_screen.dart' as checkout;
...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) {
      ...
      final onAuthRoute = state.matchedLocation == '/signin' ||
    ...
    routes: [
      ...
      GoRoute(
        ...
        name: 'cart',
        parentNavigatorKey: _rootNavigatorKey,
        builder: (context, state) => const cart.CartScreen(),
      ),
      GoRoute(
        path: '/checkout',
        name: 'checkout',
        parentNavigatorKey: _rootNavigatorKey,
        builder: (context, state) => const checkout.CheckoutScreen(),
      ),
      GoRoute(
        path: '/notifications',
        name: 'notifications',
        parentNavigatorKey: _rootNavigatorKey,
        builder: (context, state) => const NotificationControlsScreen(),
      ),
      GoRoute(
        name: 'bookDetails',
        path: '/books/:bookId',
